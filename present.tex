...
\todo[inline]{PVD, Oberflächenoxidierung}
...
Diese Fülle an Simulationen wird jedoch nicht durch eine Veröffentlichung der Potentialparametrisierungen \todo{Wort}gedeckt, so dass dennoch nur eine kleine Zahl an \ce{Al2O3}-Potentialen zur Verfügung stehen.
