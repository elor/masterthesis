...
\item Divide-and-Conquer-Algorithmen\\
  ...
  In zwei Dimensionen wird \BigO{n\log{n}} erreicht, höhere Dimensionen können per DeWall-Algorithmus mit einer Laufzeit von \BigO{n^{\lceil d/2 \rceil + 1}} behandelt werden, die sich jedoch nur in pathologischen Fällen zeigt.
