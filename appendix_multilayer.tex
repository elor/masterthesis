...
Die Auftreffenergie wird jedoch vom Thermostat vor dem eigentlichen Auftreffen reduziert, so dass sie mit \SI{5.4}{\electronvolt} \todo{Satz komplett neu}nach Untersuchungen der Schichtqualität eigentlich zu niedrig liegt.
...
\begin{figure}[!ht]
  ...
  \todoline{Joerg: Woran machst du eigentlich fest, dass es nicht in realen Prozessen so was auch gibt?}
\end{figure}
