...
\titlehead{
	...
	\end{center}
	\begin{center}
		\raisebox{-1ex}{\includegraphics[scale=1.3]{FHG_LOGO}}\\
		\hrulefill \\[1em]
...
\publishers{
	{\parbox{\textwidth-8em}{
		\begin{tabbing}
			...
			{\bf Gutachter:}	\>\dcpruefererst\\
						\>\dcprueferzweit\\
%			{\bf Erstgutachter:}	\>\dcpruefererst\\
%			{\bf Zweitgutachter:}	\>\dcprueferzweit\\
			%{\bf Zweitkorrektor:}	\>\dcadvisor
		\end{tabbing}	
	}}
}
