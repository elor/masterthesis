...
Ihre Referenzwerte wurden auf die gleiche Weise durch die Untersuchung der idealen Kristallstruktur bestimmt, welche mittels Materials Studio\cite{biovia_materials_2014} auf Basis eines $\alpha$-\ce{Al2O3}-Kristalles präpariert wurde, wobei aufgrund identischer Dichten und übereinstimmender Kristallgitter\cite{haynes_crc_2011} von einer guten Übereinstimmung der Referenzwerte mit experimentellen Werten auszugehen ist.
