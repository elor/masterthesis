...
%% \todoline{Oberflächenvalidierung}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{Schmelzpunkt in Abh. der Relaxationszeit}
...
Letztere liegen mit \SI{16.7}{\electronvolt} leicht oberhalb der üblichen Sputterenergien\todo{wie hoch?}, werden aber vor dem eigentlichen Auftreffen durch das Thermostat, welches unvermeidlich auch das auftreffende Atom betrifft, weiter reduziert.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{\SI{30}{\degree}-Stufe: Keine Poren oder Hohlräume}
...
Durch Bildung von Überhängen an den Stufen werden die Poren zu Hohlräumen abgeschlossen, welche anschließend in der Schicht verbleiben und ihre Dichte und Struktur beeinflussen\todo{Was hat Jörg dazu gesagt?}.
Die Poren zeigen sich auch in den Oberflächenrauheiten der untersuchten Strukturen (Abbildung~\ref{fig:goldroughness}).
...
\todoline{Sie sind allerdings für die verlässliche Simulation von ALD- und CVD-Prozessen notwendig.}
...
\todoline{Wort: Speedup}
\todoline{Wort: Parallelisierbarkeit}
