...
\begin{table}[H]
  ...
  \begin{tabular}{|lll|}
    ...
    Bindungslänge $r_\text{bond}$            & \SI{2.8840}{\angstrom}                         & abgeleitet                      \\
...
\begin{table}[H]
  ...
  \begin{tabular}{|lll|}
    ...
    Bindungslänge $r_\text{bond}$            & \SI{2.5562}{\angstrom}                         & abgeleitet                      \\
...
\begin{table}[H]
  ...
  \begin{tabular}{|lll|}
    ...
    Bindungslänge $r_\text{bond}$ & \SI{2.3515}{\angstrom}                      & abgeleitet                     \\
    \hline
  \end{tabular}
