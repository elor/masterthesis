...
Anders als bei Gold oder Kupfer, bei denen metallische Bindungen dominieren, oder etwa bei Salzen, die von ionischen Bindungen bestimmt werden, überwiegen in reinem Silizium \todo{wirklich?}kovalente Bindungen, so dass die mittleren Koordinationszahl von \num{3.99} anzeigt, dass alle 4 möglichen Bindungen der Siliziumatome tatsächlich ausgeprägt sind.
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{1.7cm}
    ...
    \input{img/si111_surface_profile_scale.pdf_tex}
  \end{subfigure}
