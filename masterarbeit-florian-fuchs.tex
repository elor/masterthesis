...
%\bibliographystyle{gerplain} % hässlich und keine Sortierung
...
%\bibliographystyle{klunummod} % Anjas Wahl; modifiziert damit die Namen stimmen
%\bibliographystyle{plain} %unsortiert
%\usepackage{url}
%\bibliographystyle{gerabbrv} % unsortiert
%\bibliographystyle{own} % result of some tests ...
