...
\todoline{Klar machen, dass das für Präparationen gilt, nicht nur für Parsivald}
...
\todoline{hochfrequente Bewegungen dominieren Zeitschrittweite}
...
\todoline{Anmerkung von Jörg: Das wirft natürlich die Frage auf, ob überhaupt die richtigen (also zur Substrattemperatur passenden) Strukturen gebildet werden, sofern diese temperaturabhängig sind}
...
\todoline{Vergleich der Zeiten (Schritt, $\tau$, $t_\text{relax}$, )}
...
\todoline{Formel zur Berechnung der RDF aus einer Punktwolke}
