...
$\Delta t$ ist so zu wählen, dass schnelle Bewegungen nur geringe numerische Fehler verursachen, wofür je nach Art des numerischen Integrators mindestens \todo{Wert überprüfen}$\frac{1}{10}$ der Periodendauer der schnellsten Schwingung als Richtwert angenommen werden kann.
