...
\begin{figure}[H]
  ...
  \caption{RDF-Diagramme nach der Relaxierung von c-\ce{Si}-Strukturen}
...
Bis auf die \pot{zhang}-Parametrisierung, bei der sich sämtliche MD-Simulationen aufgehangen haben, konnten alle Parametrisierungen einen dünnen Film erzeugen.
...
In der RDF der Schicht (Abbildung~\ref{fig:siliconresults-b}) ist das kristalline Substrat in Form von Spitzen erkennbar, doch zeigt sich ansonsten eine amorphe Struktur.
