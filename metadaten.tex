...
\newcommand{\dckeywords}{Dünnschichten, Gasphasenabscheidung (PVD, CVD), Atomlagenabscheidung (ALD), Multiskalenmodellierung, Kinetic Monte Carlo (KMC), Molekulardynamik (MD)}
