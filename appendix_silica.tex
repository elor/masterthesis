\chapter{Simulation der CVD-Precursormoleküle \ce{SiH4} und \ce{O2}}
...
\section{Stabilität der Precursormoleküle (\ce{SiH4}, \ce{O2})}
...
\section{Reaktion der Precursormoleküle (\ce{SiH4 + O2})}
...
Einige der \pot{zhang}-Simulationen zeigen eine Überzahl an stabilen Bindungen (Abbildung~\ref{fig:zhangreaction}), bei denen das Sauerstoff-Molekül gelegentlich aufgespalten wird, doch verringert sich ihre Wahrscheinlichkeit mit höheren Teilchenenergien und Temperaturen.
