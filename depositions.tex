...
\begin{table}[p]
  \begin{threeparttable}
    \caption[Auswahl möglicher Produkte von PVD, CVD und ALD]{
      ...
      Details zu den Produkten und Prozessgasen finden sich in den Referenzen für PVD\cite{mattox_handbook_2010,helmersson_ionized_2006}, CVD\cite{pierson_handbook_1999} und ALD\cite{puurunen_surface_2005,elliott_atomic-scale_2012,ritala_chapter_2008}.
    }
    ...
    \end{tabularx}
    \begin{tablenotes}
    \item[a] Effiziente ALD-Prozesse und Precursorpaare existieren nur für wenige Metalle\cite{ritala_chapter_2008}
    \end{tablenotes}
  \end{threeparttable}
\end{table}
...
%% {Wenn Zeit bleibt: Abbildung Beispiel Precursor-Moleküle}
...
Gerade für Anwendungen in der Mikro- und Nanoelektronik sind die strukturellen Eigenschaften der Schichten eng mit ihrer Funktion (mechanische und elektronische Eigenschaften) verknüpft\todo{Ref aus Einleitung}, so dass eine strukturelle Beschreibung für eine umfassende Betrachtung des Prozesses unerlässlich ist.
