...
Im folgenden Abschnitt soll am Beispiel von dünnen \ce{Cu-Ni}-Multilagen ein System näher untersucht werden, das GMR-Effekte zeigt, aber in der Praxis von \ce{Cu-Co}-Systemen aufgrund ihres größeren GMR-Effektes abgelöst wurde\cite{bird_giant_1995}.
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{Profil von \ce{Cu-Ni}-Multilagen mit LAMMPS}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{\subfigwidth}
