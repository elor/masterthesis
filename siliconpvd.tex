...
Besondere Bedingungen gelten für CVD-Simulationen von \ce{SiO2}-Schichten, wie sie in Abschnitt \ref{silicacvd} eingehender behandelt werden.

\subsection{Silizium-PVD}

Silizium-PVD dient in der Produktion elektronischer Artikel der Erzeugung einer dünnen, amorphen Siliziumschicht für diverse Anwendungsszenarien.
Sie soll wie bisher simuliert werden, wobei aufgrund des amorphen Charakters längere Relaxationszeiten erwartet werden.
Durch die rechenaufwendigeren ReaxFF-Potentiale 
