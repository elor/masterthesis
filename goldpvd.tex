...
\begin{figure}[p]
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{Ideales Gold-Substrat mit glatter Oberfläche}
    \label{fig:goldsubstrate-a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{\subfigwidth}
    \includegraphics[width=\textwidth]{Au_substrate_step30}
    \subcaption{Unrelaxierte Gold-Stufe, \SI{30}{\degree}}
    \label{fig:goldsubstrate-b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{\subfigwidth}
    \includegraphics[width=\textwidth]{Au_substrate_tip60}
    \subcaption{Unrelaxierte Gold-Spitze, \SI{60}{\degree}}
...
\begin{figure}[p]
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{Flächen einer \SI{30}{\degree}-Stufe: Keine Bildung von Poren oder Einschlüssen}
    \label{fig:goldpockets-a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{\subfigwidth}
    \includegraphics[width=\textwidth]{gold_tip90_pockets}
    \subcaption{Flächen einer \SI{90}{\degree}-Spitze: Bildung von Poren in direkter Umgebung der Spitze}
...
\todo[inline]{Plots oder Tabellen}
