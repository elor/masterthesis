...
Stattdessen verbleibt es in direkter Nähe zum möglicherweise ungünstigen Adsorptionsort, wodurch sich Unebenheiten verstärken können und somit die Durchmischung erhöht wird.
Ähnliche Effekte wurden von \textsc{Zhou et al.}\cite{zhou_atomistic_1998} bereits für niedrige Auftreffenergien beobachtet.
Für Systeme, die zu einer stärkeren Durchmischung neigen, sollten längere Relaxationszeiten diese hingegen zusätzlich befördern.
...
\begin{figure}[bp]
  ...
  \end{subfigure}
  \caption{Rauheit und Qualität von simulierten Kupfer-Nickel-Multilagen}
...
\begin{figure}[tp]
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{Profil von \ce{Cu-Ni}-Multilagen, Parsivald-Simulation}
  \end{subfigure}
