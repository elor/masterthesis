...
\begin{figure}
  ...
  \caption[Abscheidungskammern und -reaktoren]{
    Abscheidungskammern und -reaktoren.
    Weitere Details können Referenz~\cite{granneman_batch_2007} entnommen werden.
  }
  \label{fig:reactors}
\end{figure}
...
\begin{table}
  ...
  \todo[inline]{Referenzen notwendig?}
