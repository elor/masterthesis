...
Anhand von Silizium-PVD sollen einerseits amorphe Schichten abgeschieden, andererseits \todo{Nebensatz}zur \ce{SiH4}-\ce{O2}-CVD hingeführt werden.
...
\todoline{Einleitung nochmal versuchen}
...
In Ergänzung zu den bisherigen Voruntersuchungen, die hauptsächlich aus Optimierungen und Relaxierungen von Kristallen bestanden, kommen hier auch Simulationen der Stabilität der Precursormoleküle für \ce{SiO2}-CVD, \ce{SiH4} und \ce{O2}, sowie der Oberfläche und der amorphen Struktur hinzu, wie sie bereits in Abschnitt~\ref{mdmethods} vorgestellt wurden.
...
Dazu wurden Simulationen einzelner und mehrerer Precursormoleküle (\ce{SiH4} und \ce{O2}) im mikrokanonischen beziehungsweise kanonischen Ensemble bei verschiedenen Temperaturen simuliert und hinsichtlich ihrer Stabilität begutachtet.
...
Die Porentiefen betragen \SI{6}{\nano\meter} und wachsen linear mit der Schichtdicke.\todo{Dichte?}
...
\todoline{Der Farbgradient der Skalen wird vom Multifunktionsdrucker nicht gedruckt}

\todo{Dichte der Schicht?}

\subsection{Siliziumdioxid-CVD}

\todo{vielleicht die Voruntersuchungen von oben kopieren}
