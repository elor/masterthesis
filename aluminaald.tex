...
\todoline{Joerg: womöglich kann man das Ganze sinnvoll kürze. Die Untersuchung der verschiedenen Reaktionen in diesem Abschnitt mit den verschiedenen Parametrisierungen hinterlässt ohnehin kein besonders klares Bild beim Leser. Vielleicht würde es reichen, wenn man all das, was nicht geht, nur knapp erwähnt.}
