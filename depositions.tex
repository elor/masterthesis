...
\begin{figure}
  ...
  \parbox[c]{\subcaptionwidth}{
    \subcaption{Injektions-Kammer (CVD, ALD):
      ...
      Nebenprodukte der Oberflächenreaktionen werden mit dem Gasstromaus dem Reaktor gespült.
    }
...
Anhand der Energien der herausschlagenden Partikel und deren \todo{Größe des?}Teilchenstroms lässt sich dabei die Wachstumsrate und Qualität des abgeschiedenen Dünnfilmes beeinflussen.
...
\begin{figure}
  ...
  \caption[Schema eines vollständigen ALD-Zyklus']{
    ...
    Pulse von reaktiven Precursorgasen A (a) und B (c) werden durch Spül-Schritte mit intertem Gas (b), (d) von einander getrennt
  }
