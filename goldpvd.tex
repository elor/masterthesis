...
\begin{figure}[tbh]
  ...
  \begin{subfigure}[t]{\subfigwidth}
    ...
    \subcaption{Abhängigkeit der Simulation von $t_\text{relax}$}
  \end{subfigure}
...
\todoline{wirklich ein Fazit, oder darf der Platz auch leer bleiben?}
\subsection{Fazit}
